...
static const char __pyx_k_Helpers_Library_package_for_Pyt[] = "\nHelpers Library package for Python. \n========================================\nProvides an array of ready custom and wrapped functions \nimplemented to make the workflow easier in regards to common \nprogramming tasks. \n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "lib",
    __pyx_k_Helpers_Library_package_for_Pyt, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lib", __pyx_methods, __pyx_k_Helpers_Library_package_for_Pyt, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
